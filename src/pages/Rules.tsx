...
const Rules = () => {
  ...
  const severityBarColorMap: Record<Rule['severity'], string> = {
    low: 'bg-blue-400',
  ...
  const clusterCoverageBarMap: Record<Cluster['status'], string> = {
              ...
              return (
                <div key={value}>
                  ...
                  <div className="mt-2 h-2 rounded-full bg-muted">
                    <div
                      className={cn('h-2 rounded-full', severityBarColorMap[value] ?? 'bg-blue-400')}
              ...
              <div key={cluster.id} className="space-y-3 rounded-lg border bg-card/40 p-4">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                  <div className="w-full md:max-w-sm">
                    ...
                    <div className="mt-2 h-2 rounded-full bg-muted">
                      <div
                        className={cn('h-2 rounded-full', clusterCoverageBarMap[cluster.status])}
